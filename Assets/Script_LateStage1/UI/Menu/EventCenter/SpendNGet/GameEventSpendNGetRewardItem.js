...
public class GameEventSpendNGetRewardItem extends ListItem
{
    @SerializeField
    private var titleLabel : SimpleLabel;
    @SerializeField
    private var itemIcon : ItemPic;
    @SerializeField
    private var itemButton : SimpleButton;
    @SerializeField
    private var itemNameLabel : SimpleLabel;
    @SerializeField
    private var itemDescLabel : SimpleLabel;
    @SerializeField
    private var quantityLabel : SimpleLabel;
    @SerializeField
    ...
    @SerializeField
    private var titleRewardKey : String;
    @SerializeField
    private var titleSpendKey : String;
    @SerializeField
    private var claimToasterKey : String;
    @SerializeField
    private var splitLineImageName : String = "between line_list_small";
    
    private var milestone : GameEventDetailInfoSpendNGet.Milestone;
    private var reward : GameEventDetailInfoSpendNGet.Reward;
    private var itemCategory : MyItems.Category;
