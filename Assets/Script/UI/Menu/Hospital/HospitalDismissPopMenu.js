...
public class HospitalDismissPopMenu
	extends PopMenu
{
	...
	{
		super.Init();
		title.txt = Datas.getArString("Hospital.Dismiss_Title");
		...
		m_btnHeal.txt = Datas.getArString("Hospital.Dismiss_Button");
...
//		m_healGems.Draw();
	...
	private function priv_getCostResource() : long[]
	{
		...
		for ( var dat : HealWoundedInfo in m_woundedHealList )
		{
			...
			cost[ResourceType.ResourceFood] += Convert.ToInt64(rCost[Constant.ResourceType.FOOD]) * dat.troopHealCount;
			cost[ResourceType.ResourceOre] += Convert.ToInt64(rCost[Constant.ResourceType.IRON]) * dat.troopHealCount;
			cost[ResourceType.ResourceStone] += Convert.ToInt64(rCost[Constant.ResourceType.STONE]) * dat.troopHealCount;
			cost[ResourceType.ResourceCarmot] += Convert.ToInt64(rCost[Constant.ResourceType.CARMOT]) * dat.troopHealCount;
			cost[ResourceType.ResourceWood] += Convert.ToInt64(rCost[Constant.ResourceType.LUMBER]) * dat.troopHealCount;
			cost[ResourceType.ResourceGold] += Convert.ToInt64(rCost[Constant.ResourceType.GOLD]) * dat.troopHealCount;
		}
...
//			totalCost += costRes;
	...
	{
		PushCustomDialog(Datas.getArString("Hospital.Dismiss_Waring"),"",confirm_Destory,null);
	}
...
//			HealQueue.instance().AddQueue(queueId, m_cityId, startTime, endTime, wounded);
		...
		UnityNet.reqDoDismiss(m_cityId, 0, false, null, wounded, okFunc);
	}
	...
	public static function OnSpeedupOK() : void
	{
		...
		var hospitalHealPopMenu : HospitalDismissPopMenu = menuMgr.getMenu("HospitalDismissPopMenu");
