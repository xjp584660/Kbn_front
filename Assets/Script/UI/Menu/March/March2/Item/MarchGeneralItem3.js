public class MarchGeneralItem3 extends GeneralReincarnationInfo
{
	...
	public function SetRowData(obj:Object):void
	{
		...
		if(data ==null){
			...
			this.l_lv.txt = "0";
			attackContent.txt = "0";
			this.healthContent.txt = "0";
			l_img.mystyle.normal.background = null;
			levelIcon.SetVisible(true);
			levelIcon.mystyle.normal.background = TextureMgr.instance().LoadTexture("Button_UserInfo_lv", TextureType.DECORATION);
