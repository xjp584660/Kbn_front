...
class NewFteStep_LevelupDataInit extends StepAction
{
	...
	public function NewFteStep_LevelupDataInit(data:NewFteDisplayData)
	{
		super(data);
	}
	...
	public function Begin(fteID : int, fteStep : NewFteStep) 
	{
		...
		var strengthen : StrengthenTab = null;
		for ( var iPos : int = 0; iPos != armMenu.tabControl.Items.Length && strengthen == null; ++iPos )
		{
			strengthen = armMenu.tabControl.Items[iPos] as StrengthenTab;
		}
		...
		if ( strengthen != null )
		{
			...
			strengthen.Data = GearData.Instance().CurrentArm;
		}
		super.Begin(fteID, fteStep);
	}
