...
#if UNITY_EDITOR
                UnityEngine.Debug.LogWarning("<color=#5474F1FF>TAException (Log)</color> " + reasonStr + "\n------------------");
#endif
...
#if UNITY_EDITOR
            UnityEngine.Debug.LogWarning("<color=#5474F1FF>TAException (UncaughtException) </color> " + reasonStr + "\n------------------");
#endif
            //退出程序，bug反馈程序重启主程序
            if ( IsQuitWhenException )
            {
