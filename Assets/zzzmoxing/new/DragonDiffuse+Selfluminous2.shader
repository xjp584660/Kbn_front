...
//	o.Alpha =_Color.a + ( c1.rgb+_Alphapow);// c1.a + c2.a;
//	o.Emission = (o.Alpha * 2 * _Selflu) + ((_RimColor.rgb * pow (rim, _RimPower)) * _RimColor.a * _Rimstrong)+c4.rgb;
//}
//ENDCG
//}
...
//	clip (frac((IN.screenPos.x*_sr + IN.screenPos.y)/IN.screenPos.w * (_scrH*0.3)) - _sz);	
    ...
    fixed4 g1 = tex2D(_EmissionTex, IN.uv_ID01Tex);
   		   g1.rgb = g1.rgb * _EmissionMultiple;
...
//           screenUV *= float2(_EFu,_EFv);
//    fixed3 c3 = tex2D (_EFTex, screenUV );
//    fixed3 c3 = (c3.rgb - c3.rgb * pow (rim, _RimEF))*_EFCol*0.5;
	fixed  a1 = c1.a ;
	o.Albedo = c1.rgb;//  + c2.rgb ;
	o.Alpha =1 + ( c1.r+c1.g+c1.b+_Alphapow);// + c2.a;
	o.Emission = ((a1 * 2 * _Selflu) + ((_RimColor.rgb * pow (rim, _RimPower)) * _RimColor.a * _Rimstrong)) + g1;
}
ENDCG
}
